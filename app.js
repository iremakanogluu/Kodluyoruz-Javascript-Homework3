...
const createContent = (item) => {
  let content = `<div class="menu-items col-lg-6 col-sm-12">
...
const listAllFoods = () => {
  ...
  menu.map(item => {listAllFoods += createContent(item)});

  menuDOM.innerHTML = listAllFoods;
}
...
const listKoreanFoods = () => {
  ...
  menu.map(item => {
    if(item.category === "Korea"){
      listKoreanFoods += createContent(item);
    }
  })
  menuDOM.innerHTML = listKoreanFoods;
}
...
const listJapanFoods = () => {
  ...
  menu.map(item =>{
    if(item.category === "Japan"){
      listJapanFoods += createContent(item);
    }
  })
  menuDOM.innerHTML = listJapanFoods;
}
...
const listChinaFoods = () => {
  ...
  menu.map(item => {
    if(item.category === "China"){
      listChinaFoods += createContent(item);
    }
  })
  menuDOM.innerHTML = listChinaFoods;
}
